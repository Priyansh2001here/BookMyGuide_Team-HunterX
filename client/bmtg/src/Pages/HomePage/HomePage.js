        ...
        async function fetchPlaces() {
            ...
            try {
                const response = await axios.get(
                    DJANGO_URL + "/guide/all-places?location__state=&location__city=" + currCityName
                );
        ...
        >
            ...
            <div className="tourListDisplay" style={{marginBottom: "80px"}}>
              ...
              <i
                  ...
                  style={{color: "#f33030", fontSize: "12px"}}
              />
            </span>
                    </h3>
                    <Link
                ...
                <div className="tourLists" style={loader ? {
                    display: "flex",
                    ...
                    {loader ? (
                        ...
                        places.length === 0 ? "Sorry We Aren\"t operating in " + currCityName :places.slice(0, 2).map((place) => <PlaceCard key={place.id} data={place}/>)
                    )}
                </div>
            </div>
        </div>
